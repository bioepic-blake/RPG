...
namespace RPG3
{
	public class forestVC : UIViewController
	{
		...
		{
			enermy arcaneHunter = new arcaneHunter("hunter", "Holy crosbow");
			...
			arcaneHunter ah = new arcaneHunter("hunter", "holy crosbow");
			string name = ah.Name;
			EnermyName = name;
			string weapon = ah.weaponName;
			EnermyWeapon = weapon;
		}
		...
		private void LblNt()
		{
			...
			_LblNarrater.Text = $"you enter the dark forest and are attacked by a {EnermyName} using a {EnermyWeapon} ";
