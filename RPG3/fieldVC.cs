...
namespace RPG3
{
	public class fieldVC : UIViewController
	{
		...
		public void enermyIN()
		{
			...
			zombie z = new zombie("crying zombie", "broken shield");
			string name = z.Name;
			EnermyName = name;
		...
		private void LblNt()
		{
			...
			_LblNarrater.Text = $"you walk through the corn field and are attacked by a {EnermyName} using a {EnermyWeapon} ";
